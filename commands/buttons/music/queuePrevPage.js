  ...
  async execute(interaction, client) {
    try {
      ...
      if (currentPageNumber <= 1) {
        //* disable the previous button when user reached the end of the pages
      ...
      const queueString = interaction.message.queueTracks
        ...
        .map((song, index) => {
          return (
            //* [currentPageNumber - 1 (Ex.page 2 - 1 = 1)] &  [index + 1 (E.x track 1)] = page 2 --> track 11
